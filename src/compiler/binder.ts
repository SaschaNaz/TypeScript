    ...
    function computeOther(node: Node, kind: SyntaxKind, subtreeFlags: TransformFlags) {
        ...
        switch (kind) {
            ...
            case SyntaxKind.SpreadAssignment:
                transformFlags |= TransformFlags.AssertES2018 | TransformFlags.ContainsObjectSpread;
                break;
            ...
            case SyntaxKind.ObjectBindingPattern:
                ...
                if (subtreeFlags & TransformFlags.ContainsRest) {
                    transformFlags |= TransformFlags.AssertES2018 | TransformFlags.ContainsObjectRest;
                }
